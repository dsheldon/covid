...
class SEIRD(SEIRDBase):    
    ...
    def __call__(self,
        ...
        dow_knots = onp.arange(7)
        dow_basis = onp.array(splines.bs(onp.arange(0,7),knots=dow_knots,degree=1))
        dow_num_basis = dow_basis.shape[1]
        ...
        #dow_tau = numpyro.sample('dow_scale_on_coef',dist.Normal(0,1000))
        #dow_a_raw = numpyro.sample('dow_a_raw',dist.GaussianRandomWalk(scale=1e-2, num_steps=dow_num_basis))       
        ...
        params = (beta0, 
                  ...
                  det_prob_d, 
                  death_dist,
                  basis,tau,a_raw)#,dow_basis,dow_tau,dow_a_raw)
        ...
        if T_future > 0:
            ...
            params = (beta0, 
                      ...
                      death_rate, 
                      det_prob_d,
                      death_dist,basis,tau,a_raw)#,dow_basis,dow_tau,dow_a_raw)
    ...
    def dynamics(self, T, params, x0, num_frozen=0, confirmed=None, death=None, suffix="",N=None):
        ...
        death_rate, \
        det_prob_d, \
        death_dist,basis,tau,a_raw = params#,dow_basis,dow_tau,dow_a_raw = params
