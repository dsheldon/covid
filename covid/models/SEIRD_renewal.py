...
class SEIRD(SEIRDBase):    
    ...
    def __call__(self,
        ...
        if T_future > 0:
            ...
            beta_f, det_rate_rw_f, x_f, y_f, z_f = self.dynamics(T, 
                                                                 params, 
                                                                 x0,
                                                                 suffix="_future",N=N,T_future=T_future+1)
    ...
    def simulate_renewal(self,x0,N,T,theta,CONV_WIDTH=40): 
         ...
         R = N-S-E-I
         return (dI,dD) 
    def dynamics(self, T, params, x0, num_frozen=0, confirmed=None, death=None, suffix="",N=None,T_future = 0):
        ...
        new_cases,new_deaths = self.simulate_renewal(x0[1],N,T+T_future,theta,CONV_WIDTH=40) 
