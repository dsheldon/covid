...
class SEIRD(SEIRDBase):    
    ...
    def __call__(self,
        ...
        a_raw2 = numpyro.sample('a_raw2',dist.GaussianRandomWalk(scale=1e-2, num_steps=num_basis))
        '''
        ...
        if T_future > 0:
            ...
            params = (beta0, 
                      ...
                      death_rate, 
                      det_prob_d,
                      death_dist,basis,tau,a_raw,tau2,a_raw2)
    ...
    def dynamics(self, T, params, x0, num_frozen=0, confirmed=None, death=None, suffix="",N=None):
        ...
        death_rate, \
        det_prob_d, \
        death_dist,basis,tau,a_raw,tau2,a_raw2 = params
        ...
        new_deaths = np.exp(np.dot(basis_oos_matrix,tau2*a_raw2)) #np.convolve(dH, D_pmf,mode='full')[:T]
