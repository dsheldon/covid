...
for place in places:
    ...
    print (daily_df)#.iloc['2021-04-10'])
    daily_df.loc['2021-04-10'].value = 0
    daily_df.loc['2021-04-11'].value = 0
    daily_df.loc['2021-04-17'].value = 0
    daily_df.loc['2021-04-18'].value = 0
    daily_df.loc['2021-04-25'].value = 0
    daily_df.loc['2021-04-26'].value = 0
...
fname = "../submission_files/incident/"+ forecast_date.strftime('%Y-%m-%d') + "-" + model_name + ".csv"
